 ...
 * @LastEditTime: 2022-10-02 20:12:19
                            ...
                            <div className="login-wrap p-4 p-md-5">
                                ...
                                <form action="#" className="signin-form">
                                    <div className="form-group mt-3">
                                        <input type="text" className="form-control" required value={email} onChange={(e)=>{
                                    ...
                                    <div className="form-group">
                                        <button onClick={submit} type="submit" className="form-control btn btn-primary rounded submit px-3" >{way==='login'?"登录":"注册"}</button>
                                    </div>

                                </form>
                                <p className="text-center"> <a data-toggle="tab" href="#signup" onClick={()=>{ way==='login'?setWay('register'):setWay('login')}}>{way==='login'?"立即注册":"立即登录"}</a></p>
                            </div>
                        </div>
                    </div>
                </div>
